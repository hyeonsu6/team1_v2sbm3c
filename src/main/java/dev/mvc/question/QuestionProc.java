...
public class QuestionProc implements QuestionProcInter {
  ...
  @Override
  public ArrayList<QuestionVO> list_by_fcateno(int fcateno) {
    ArrayList<QuestionVO> list = this.questionDAO.list_by_fcateno(fcateno);
    return list;
  }
  ...
  @Override
  public ArrayList<QuestionVO> list_by_fcateno_search(HashMap<String, Object> hashMap) {
    ArrayList<QuestionVO> list = this.questionDAO.list_by_fcateno_search(hashMap);
    return list;
  }
  ...
  @Override
  public ArrayList<QuestionVO> list_by_fcateno_search_paging(QuestionVO questionVO) {
    ...
    ArrayList<QuestionVO> list = this.questionDAO.list_by_fcateno_search_paging(questionVO);
    return list;
  }
...
//    str.append("현재 페이지: " + nowPage + " / " + totalPage + "  "); 
  ...
  public int delete_by_fcateno(int fcateno) {
    int cnt = this.questionDAO.delete_by_fcateno(fcateno);
    return cnt;
  }
