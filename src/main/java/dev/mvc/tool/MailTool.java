...
public class MailTool {
  ...
  public int send(String receiver, String from, String title, String content) {
    ...
    Session session = Session.getInstance(props, new javax.mail.Authenticator() {
        protected PasswordAuthentication getPasswordAuthentication() {
            String user="a94365196@gmail.com";
            String password="fnqkfdbahisorkxh";
   ...
   */
  public void send_file(String receiver, String from, String title, String content, MultipartFile[] file1MF, String path) {
    Properties props = new Properties();
    props.put("mail.smtp.host", "smtp.gmail.com");
    props.put("mail.smtp.port", "587");
    props.put("mail.smtp.auth", "true");
