...
<c:set var="replyno" value="${param.replyno }" /> <%-- mav.addObject("questno", questionVO.getQuestno()); // redirect parameter 적용 --%>
<c:set var="reviewno" value="${param.reviewno }" /> <%-- mav.addObject("fcateno", questionVO.getFcateno()); // redirect parameter 적용 --%>
  ...
  <fieldset class='fieldset_basic'>
    <UL>
      ...
      <li class='li_none'>
        ...
        <button type='button' onclick="location.href='./create.do?fcateno=${fcateno}'" class="btn btn-dark btn-sm">새로운 질문 등록</button>
        <button type='button' onclick="location.href='./list_all.do?'" class="btn btn-dark btn-sm">목록</button>
        <button type='button' onclick="location.href='./list_by_fcateno.do?fcateno=${fcateno}'" class="btn btn-dark btn-sm">카테고리 별 질문 목록</button>
      </li>
    </UL>
  </fieldset>
