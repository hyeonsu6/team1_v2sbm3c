...
<script type="text/javascript">
  ...
  function send() {
    ...
    // 처리중 출력
    current_passwd_msg.innerHTML="<img src='/member/images/ani04.gif' style='width: 70px;'>"; // static 기준
  }
	...
	<div style='width: 60%; margin: 0px auto;'>
		<form name='frm' id='frm' method='POST' action='./passwd_update.do'>
			...
			<div class="bottom_menu">
				<button type="button" id='btn_send' class="btn btn-outline-warning btn-sm" style="background-color: #B8860B;">비밀번호 변경</button>
				<button type="button" onclick="history.back()" class="btn btn-outline-warning btn-sm"
					style="background-color: #B8860B;">비밀번호 취소</button>
			</div>
