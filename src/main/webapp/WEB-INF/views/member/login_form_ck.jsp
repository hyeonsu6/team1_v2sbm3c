...
<title>Festival Blog Member Login</title>
			...
			<div style='width: 40%; margin: 50px -50px 0px auto;'>
				<form name='frm' method='POST' action='./login.do'>
					...
					<div class="login_bottom_menu" style="margin-left: -200px; text-align: center;">
						<br>
						<button type="submit" class="btn btn-outline-warning btn-sm" style="margin-right: 3px; ">로그인</button>
						<button type='button' id='btn_create' class="btn btn-outline-warning btn-sm">회원가입</button>
					</div>
				</form>
			</div>
		</div>
