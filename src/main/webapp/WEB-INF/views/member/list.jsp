...
<c:import url="/menu/top.do" />
  ...
  <table class="table table-striped" style='width: 100%;'>
    ...
    <TR>
      <TD class='td_basic'>
        <c:choose>
          <c:when test="${grade >= 1 and grade <= 10}"><img src='/member/images/admin.png' title="관리자" class="icon_New"></c:when>    
          <c:when test="${grade >= 11 and grade <= 20}"><img src='/member/images/user.png' title="회원" class="icon_New"></c:when>
          <c:when test="${grade >= 40 and grade <= 49}"><img src='/member/images/pause.png' title="정지 회원" class="icon_New"></c:when>
          <c:when test="${grade == 99}"><img src='/member/images/x.png' title="탈퇴 회원" class="icon_New"></c:when>
        </c:choose>  
      </TD>
