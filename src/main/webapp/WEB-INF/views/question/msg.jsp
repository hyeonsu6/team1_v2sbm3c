...
<c:set var="questno" value="${param.questno }" /> <%-- mav.addObject("questno", questionVO.getQuestno()); // redirect parameter 적용 --%>
<c:set var="fcateno" value="${param.fcateno }" /> <%-- mav.addObject("fcateno", questionVO.getFcateno()); // redirect parameter 적용 --%>
