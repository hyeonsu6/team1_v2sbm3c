...
<div style='width: 100%;'>
	<c:forEach var="festivalVO" items="${list }" varStatus="status">
		...
		<div
			...
			class='title_link'
			style='width: 18%; height: 190px; margin: 0.5%; padding: 0.3%; font-size: 16px; background-color: #87CEFA; text-align: center; 
			display: inline-block; vertical-align: top; border-radius: 15px; border:7px #1E90FF ridge;'>
			...
			<div style="margin-top: 10px;">
				<span style="font-size: 0.8em; color: #FFFFF0;">
					<c:choose>
