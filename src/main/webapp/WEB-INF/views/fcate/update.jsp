...
<body>
	...
	<form name='frm' method='post' action='/fcate/update.do'>
		...
		<div>
			<label>카테고리 이름</label> <input type="text" name="name" value="<%=fcateVO.getName()%>" required="required"
				autofocus="autofocus" class="form-control form-control-sm" style="width: 50%">
		</div>

		<div style="margin-top: 20px;">
			<label>글수</label> <input type="text" name="cnt" value="<%=fcateVO.getCnt()%>" required="required"
				autofocus="autofocus" class="form-control form-control-sm" style="width: 50%">
		</div>
